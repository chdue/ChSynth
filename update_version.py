...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright chdue, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/MyFirstDistortion-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstDistortion-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstDistortion-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstDistortion-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstDistortion-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstDistortion-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/MyFirstDistortion-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/MyFirstDistortion.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MyFirstDistortion.iss",inplace=1):
